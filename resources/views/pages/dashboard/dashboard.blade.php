                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col">
                                            <div class="col-md-6">
                                                <form
                                                    action="{{ route('dashboard.terimaPesan', ['id' => $tamu_pesan->id]) }}"
                                                    method="POST">
                                                    @csrf
                                            ...
                                            <div class="col-md-6">
                                                <form
                                                    action="{{ route('dashboard.hapusPesan', ['id' => $tamu_pesan->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <p class="mb-4">{!! \Illuminate\Support\Str::markdown(data_get($aiProfiling, 'summary',
                                    'Tidak ada ringkasan.')) !!}
