...
Route::middleware(['userRole:admin,wakasek'])->group(function () {
    ...
    Route::post('/administrasi/users/{user}', [UserController::class, 'update']);

    Route::get('/akademik/relasi-kelas', [ClassGradeController::class, 'index'])->name('class-grade.index');
    Route::get('/akademik/relasi-kelas/{kelas}', [ClassGradeController::class, 'show'])->name('class-grade.show');
    Route::post('/akademik/relasi-kelas/{kelas}/mapel/{mapel}', [ClassGradeController::class, 'store'])->name('class-grade.store');
});
...
Route::middleware(['userRole:admin,wakasek'])->group(function () {
    ...
    // ==============[ R e k a p - A b s e n s i ]===============
    Route::get('/akademik/absensi/admin', [AbsensiController::class, 'showAbsensiAdmin'])->name('absensi.admin');

});
//======================== G U R U =========================================================
Route::middleware(['userRole:guru'])->group(function () {
    Route::get('/guru/absensi', [AbsensiController::class, 'guruIndex'])->name('guru.absensi.index');
    Route::get('/guru/absensi/{detail_jadwal}', [AbsensiController::class, 'guruShow'])->name('guru.absensi.show');
    Route::post('/guru/absensi/{detail_jadwal}', [AbsensiController::class, 'guruStore'])->name('guru.absensi.store');
});
...
Route::middleware(['userRole:siswa,admin'])->group(function () {
    ...
    Route::get('/siswa/performa', [StudentPerformanceController::class, 'index'])->name('siswa.performance');
});
